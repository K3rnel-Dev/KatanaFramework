...
class main_ganerator:
	def __init__(self, level=0, pwd_min=8, pwd_max=12, num_range=0,
				 leeter=False, years=0, chars=True, verbose=True, export='../loot/passwords.txt'):
		# Complication levels:
		# 0 = default
...
@click.option('-x', '--export', metavar='', type=str, default='../loot/passwords.txt', help='Name of the file to export results to it.')
